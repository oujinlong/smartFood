<template>
	<view class="self-container">
		...
		<!-- 备注 -->
		<view style="font-size: 30upx; font-weight: 600;padding: 10upx 10upx 10upx 24upx;">Remark</view>
		<view class="uni-flex uni-row align-center bg_white"><input placeholder="remark" v-model="remark" style="margin: 10upx 10upx 10upx 24upx;height: 40upx;" /></view>

		<!-- bottom bar -->
		<view class="bottom_bar uni-flex uni-row justify-between align-center">
			<view>
				<label style="color: #ffffff;font-size: 36upx; margin-left: 48upx;">${{ totalAll }}</label>
				<label style="margin-left: 30upx; color: #ffffff;font-size: 38upx;">|</label>
				<label style="color: #ffffff;font-size: 30upx;margin-left: 30upx;">Discount $ -{{ totalDiscount }}</label>
			</view>

			<view class="pay_now_btn uni-flex uni-row justify-center align-center">Pay Now</view>
		</view>
	</view>
</template>
